...
BaseFldr = 'G:\Imperial\PhD\Rashid\'; % Base directory containing calculation directory ("\" included at end)
system = 'AlO_water_0.33ML_MD'; % Name of calculation directory (no "\")
Trajectory = 'AlO_water_0.33ML_MD-pos-1.xyz';
...
fidout = fopen([BaseFldr system setOSpathSep 'final_test.xyz'], 'w');
