function Bader3DCharge_fixV3_8_7(TrajXYZ, TrajABC, TrajQmc, varargin)
...
[hAtoms, hVectors] = updatePlot(ax, TrajXYZ{1}, TrajABC{1}, TrajQmc{1},...
    ...
    currentFrame, numFrames, hAtoms, hVectors);
...
if params.SaveVideo
    for frame = 1:numFrames
        [hAtoms, hVectors] = updatePlot(ax, TrajXYZ{frame}, TrajABC{frame},...
            ...
            frame, numFrames, hAtoms, hVectors);
        % ... [rest unchanged] ...
    ...
    function playCallback(src)
        ...
        while loopActive && ishandle(src)
            ...
            [hAtoms, hVectors] = updatePlot(ax, TrajXYZ{currentFrame},...
                ...
                xs, ys, zs, Radius, CombinedIndices{currentFrame}, ExcludedIndices{currentFrame}, currentFrame, numFrames, hAtoms, hVectors);
        ...
        while params.PlayVideo && (params.LoopVideo || playCount == 0)
            for frame = 1:numFrames
                ...
                [hAtoms, hVectors] = updatePlot(ax, TrajXYZ{frame},...
                    ...
                    xs, ys, zs, Radius, CombinedIndices{frame}, ExcludedIndices{currentFrame}, frame, numFrames, hAtoms, hVectors);
...
function [hAtoms, hVectors] = updatePlot(ax, XYZ, ABC, Qmc, xs, ys, zs, Radius,...
    CombinedIndices, ExcludedIndices, currentFrame, numFrames, hAtoms, hVectors)  % Added ExcludedIndices
