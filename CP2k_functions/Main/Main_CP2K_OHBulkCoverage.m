...
system = 'AlO_0.5ML_OH';
Trajectory = 'AlO_0.5ML_OH_99000to140000_1000step.xyz';
...
O_OH_vmd_indx{i} = zeros(nConfigs, 1);
H_OH_vmd_indx{i} = zeros(nConfigs, 1);
O_H3O_vmd_indx{i} = zeros(nConfigs, 1);
...
OH_O_Mat_indx{i}=Indx.O(cond_OH);
OH_H_Mat_indx{i}=Indx.H(cOH(ismember(rOH,cond_OH)));
OH_O_vmd_indx{i}=OH_O_Mat_indx{i}-1;
OH_H_vmd_indx{i}=OH_H_Mat_indx{i}-1;
...
H3O_O_Mat_indx{i}=Indx.O(cond_H3O);
H3O_H_Mat_indx{i}=Indx.H(cOH(ismember(rOH,cond_H3O)));
H3O_O_vmd_indx{i}=H3O_O_Mat_indx{i}-1;
H3O_H_vmd_indx{i}=H3O_H_Mat_indx{i}-1;
