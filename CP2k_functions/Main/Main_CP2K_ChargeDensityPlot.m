...
plot(linspace(0, ABC(3), zGrid), smooth(reshape(mean(GridDens.(['C' num2str(j)]), [1 ,2]),zGrid,1), floor((2/ABC(3))*zGrid)), 'Color', 'r', 'LineWidth', 1.5);
end
...
plot(linspace(0, ABC(3), zGrid), smooth(reshape(mean(AveGridDens, [1 ,2]),zGrid,1), floor((2/ABC(3))*zGrid)), 'Color', 'k', 'LineWidth', 1.5);
