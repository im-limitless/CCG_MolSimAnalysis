...
%     CreateSubmissionFile(MyCluster, BaseOutFldr, fldrname, Walltime, ncores, ppn, 'No');
    ...
    % into each directory
    copyfile('G:\Imperial\CP2k_files\GTH_POTENTIALS', [BaseOutFldr fldrname '\GTH_POTENTIALS']);
    copyfile('G:\Imperial\CP2k_files\GTH_BASIS_SETS', [BaseOutFldr fldrname '\GTH_BASIS_SETS']);
    copyfile('G:\Imperial\CP2k_files\dftd3.dat', [BaseOutFldr fldrname '\dftd3.dat']);
